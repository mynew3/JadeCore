...
enum WorldIntConfigs
{
    ...
    CONFIG_ANTICHEAT_MAX_REPORTS,
    CONFIG_ANTICHEAT_REFRESH_TIME,
    CONFIG_ANTICHEAT_AVERAGE_SPEED,
    CONFIG_ANTICHEAT_IGNORE_LATENCY,
    CONFIG_ANTICHEAT_IGNORE_ACCOUNT_RANK,
