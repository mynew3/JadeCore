...
char serviceLongName[] = "JadeCore auth service";
char serviceDescription[] = "JadeCore World of Warcraft emulator auth service";
/*
...
int main(int argc, char** argv)
{
    ...
    TC_LOG_INFO("server.authserver", "               ╚═════╝ ╚═════╝ ╚═╝  ╚═╝╚══════╝"); 
    TC_LOG_INFO("server.authserver", "   ");                                                        
    TC_LOG_INFO("server.authserver", "  	JadeCore 2016(c) Open-Sourced Game Emulation"); 
    TC_LOG_INFO("server.authserver", "		       https://www.jadecore.tk ");
    TC_LOG_INFO("server.authserver", "");  
